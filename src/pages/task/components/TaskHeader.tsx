...
const toggleBtnBase =
  "w-11 h-10 rounded-md grid place-items-center border border-gray-300 bg-white hover:bg-gray-100 transition";
    ...
    <div className="flex items-center justify-between px-12 py-4 bg-white">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={[
            toggleBtnBase,
            view === "list" ? toggleBtnActive : "",
          ].join(" ")}
          onClick={() => onChangeView("list")}
          aria-label="list view"
        >
          <img src={IconList} alt="리스트뷰" />
        </button>
        <button
          type="button"
          className={[
            toggleBtnBase,
            view === "kanban" ? toggleBtnActive : "",
          ].join(" ")}
          onClick={() => onChangeView("kanban")}
          aria-label="kanban view"
        >
          <img src={IconKanban} alt="칸반뷰" />
        </button>
      </div>
      ...
      <div className="flex items-center gap-2">
        <button className="flex h-10 px-3 rounded-md border border-gray-300 bg-white text-body2 text-gray-700 hover:bg-gray-100 items-center">
          <img src={IconFilter} alt="필터" className="w-5 h-5" />
          필터
        </button>
        <button className="flex h-10 px-3 rounded-md border border-gray-300 bg-white text-body2 text-gray-700 hover:bg-gray-100 items-center">
          <img src={IconSort} alt="정렬" className="w-5 h-5" />
          정렬
        </button>
        <button className="flex h-10 px-4 rounded-md bg-primary-500 text-white text-body2 hover:opacity-90 items-center">
          <img src={IconPlus} alt="" className="w-5 h-5" />
          업무 추가하기
        </button>
      </div>
    </div>
